...
| RC-035 | 2026-07-17 05:18:00 +08:00 | 待本项记录提交后固定 | SUBMITTED WITH PENDING CONFIRMATION：兔兔素材源文件缺失、授权未知，已建立 SHA-256 登记与发布阻断门禁；校验器与 Ruff 通过 | `docs/evidence/RC-035/README.md` | 源文件、权利人书面声明、许可证、署名条款和发布批准待确认 |
