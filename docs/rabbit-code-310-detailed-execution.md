...
| 当前状态 | RC-038 已冻结 Windows/Linux 首发平台矩阵、x86_64 正式基线、终端/Shell、CPU/GPU、未签名制品、SHA-256、验证环境和责任角色；准备执行 RC-039 |
| 当前阻塞 | RC-037 访谈/产品范围评审仍待确认；RC-038 正式格的 Linux 实机、安装包、ARM/GPU 实测待后续 RC，不阻塞 RC-039 |
| 最近一次完整验证 | 2026-07-17：RC-038 矩阵结构与范围审查、RC-037 Persona 校验、RC-036 汇总、RC-035 授权/发布阻断、RC-034 名称渠道、Ruff、第三方登记、source-map denylist、专有内容政策与 RC 追踪检查通过；平台组合实测按证据记录保持待确认 |
| 最近更新时间 | 2026-07-17 13:12:09 +08:00 |
| 更新人/Agent | Codex |
...
| RC-038 | 2026-07-17 13:12:09 +08:00 | 待本项记录提交后固定 | SUBMITTED WITH PENDING CONFIRMATION：Windows/Linux 首发平台矩阵、x86_64 正式基线、终端/Shell、CPU/GPU、未签名制品、SHA-256、验证环境和责任角色已冻结；组合实测待后续 RC | `docs/evidence/RC-038/README.md` | Linux 实机、未签名安装包、ARM/GPU 和 Fedora rpm 实测待后续平台/安装包/测试 RC；macOS 不在首发范围 |
